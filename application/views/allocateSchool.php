                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <form action="" method="POST" class="form-inline my-2 my-lg-0">
                            ...
                            <input class="form-control mr-sm-2" type="text" name="search_email" id="search_email" placeholder="Search by email" aria-label="Search">
                        </form>
                        <br />
                        <div id="result"></div>
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:"<?php echo base_url(); ?>userSearch/fetchCoordinator",
                method:"POST",
