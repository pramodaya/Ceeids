...
<div id="wrapper">
                            ...
                            <div class=\"col-md-8\">
                                    ...
                                    <div class=\"form-row\">
                                        <div class=\"col-md-6\">
                                            ...
                                            <div class=\"form-label-group\">
                                                <input type=\"text\"  id=\"firstName\" disabled value='$perreq->firstName' name=\"firstName\" class=\"form-control\" placeholder=\"First name\" required=\"required\" autofocus=\"autofocus\">
                                                <label for=\"firstName\">First name</label>
                                            </div>
                                        </div>
                                        <input type=\"text\" id=\"id\" readonly name=\"uid\" value='$perreq->uid' class=\"form-control\" required=\"required\" hidden autofocus=\"autofocus\">

                                        <div class=\"col-md-6\">
                                            <div class=\"form-label-group\">
                                                <input type=\"text\" disabled id=\"lastName\" value='$perreq->lastName' name=\"lastName\" class=\"form-control\" placeholder=\"Last name\" required=\"required\">
                                ...
                                <div class=\"form-group\">
                                    <div class=\"form-row\">
                                        ...
                                        <div class=\"col-md-6\">
                                            <div class=\"form-label-group\">
                                                <input type=\"datetime\" value='$perreq->signInTime' disabled id=\"signInTime\"  class=\"form-control\" placeholder=\"Email address\" required=\"required\">
                                                <label for=\"signInTime\">Registered Date</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class=\"col-md-6\">
                                            <div class=\"form-label-group\">
                                                <select id=\"inputState\" readonly name=\"userType\"class=\"form-control\">
                                                    <option value='$perreq->userType'>$perreq->userType</option>                                          
                                                </select>
                                            </div>
                                        </div>
                                        <div class=\"col-md-6\">
                                            <div class=\"form-label-group\">
                                                <input type=\"text\"disabled value='$perreq->contactNumber' name=\"contactNumber\" id=\"contactnumber\" class=\"form-control\" placeholder=\"Contact Number\" required=\"required\">
    ...
    <div class=\"col-md-8\">
      ...
      <input type=\"text\" class=\"form-control\" name='username' id=\"username\" required placeholder=\" $perreq->userType XXX\" onkeyup=\"check_if_exists();\">
    ...
    <div class=\"col-md-2\" id=\"passwordText\"></div>
                            ...
                            <div class=\"col-md-4\">
                                <div class=\"col-md-12\">
                                    <img style='max-width: 100%' src='".base_url()."assets/img/profileImages/$perreq->imgUrl'>
