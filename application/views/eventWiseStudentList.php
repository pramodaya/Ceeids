                ...
                <div class="card-body">
                    <div class="row">
                        <div class='col-md-6 text-center'>
                            <a class='btn btn-outline-danger' href=<?php echo base_url();?>adminController/print_item?event_id=<?php echo $event_id;?>>Export PDF</a>
                        </div>
                        <div class='col-md-6 text-center'>
                            <form method="post" action='<?php echo base_url();?>adminController/action'>
