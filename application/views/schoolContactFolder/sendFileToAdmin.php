        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <?php endif;?>
                    <form action="<?php echo base_url();?>schoolContacts/saveMessage" method="POST">
                        <div class="form-group">
                            <label for="exampleInputTitle">Title</label>
                            <input type="text" name="title"  class="form-control" id="exampleInputTitle" aria-describedby="emailHelp" placeholder="Enter Title">
                            <small id="emailHelp" class="form-text text-muted">Give a Meaningful Title.</small>
                        </div>
